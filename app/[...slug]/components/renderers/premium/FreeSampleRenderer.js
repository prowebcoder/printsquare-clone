...
const RequestingSample = dynamic(() => import('@/components/modals/RequestingSample'), {
  ssr: false,
  loading: () => null
});
...
export default function FreeSampleRenderer({ component, index }) {
  ...
  return (
    <>
      ...
      {/* Render the modal if button type is modal */}
      {content.buttonType === 'modal' && (
        <RequestingSample 
