// app/api/send-quote/print-quote/route.js
...
export async function POST(request) {
  try {
    ...
    const mailOptions = {
      ...
      subject: `New Perfect Binding Book Quote - ${formData.selectedSize}`,
...
function formatEmailText(formData) {
  return `
New Perfect Binding Book Quote Request
...
<head>
    <style>
        ...
        .value { color: #2d3748; }
        .highlight { background: #e6fffa; padding: 20px; border-radius: 8px; border: 2px solid #81e6d9; margin: 20px 0; }
        .addon-tag { display: inline-block; background: #c6f6d5; color: #22543d; padding: 4px 12px; border-radius: 20px; margin: 2px 4px; font-size: 12px; }
        .total { font-size: 24px; font-weight: bold; color: #2b6cb0; text-align: center; }
...
<body>
    <div class="container">
        <div class="header">
            <h1>New Perfect Binding Book Quote Request</h1>
            <p>Professional Book Printing Service</p>
        </div>
        ...
        <div class="footer">
            ...
            <p>• This is an automated quote request from your Perfect Binding form</p>
        </div>
    </div>
</body>
</html>
