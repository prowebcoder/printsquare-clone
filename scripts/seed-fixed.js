...
async function seed() {
  try {
    ...
    // Define a clean schema without formId
    ...
    // Create configurations using update with upsert to avoid index issues
    console.log('📝 Creating configurations...');
    
    await FormConfiguration.updateOne(
      { name: 'print-quote' },
      {
        name: 'print-quote',
        type: 'predefined',
